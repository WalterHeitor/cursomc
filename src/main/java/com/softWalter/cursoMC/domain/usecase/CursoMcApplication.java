...
import com.softWalter.cursoMC.domain.enties.PagamentoComBoleto;
import com.softWalter.cursoMC.domain.enties.PagamentoComCartao;
import com.softWalter.cursoMC.domain.enties.Pedido;
import com.softWalter.cursoMC.domain.enties.Produto;
import com.softWalter.cursoMC.domain.enties.enums.EstadoPagamento;
import com.softWalter.cursoMC.domain.enties.enums.TipoCliente;
import com.softWalter.cursoMC.domain.repositories.CategoriaRepository;
import com.softWalter.cursoMC.domain.repositories.CidadeRepository;
import com.softWalter.cursoMC.domain.repositories.ClienteRepository;
import com.softWalter.cursoMC.domain.repositories.EnderecoRepository;
import com.softWalter.cursoMC.domain.repositories.EstadoRepository;
import com.softWalter.cursoMC.domain.repositories.PagamentoRepository;
import com.softWalter.cursoMC.domain.repositories.PedidoRepository;
import com.softWalter.cursoMC.domain.repositories.ProdutoRepository;
